    ...
    <nav className=" w-full ">
      <div className="container mx-auto  py-2 flex justify-between items-center">
        ...
        <ul className="hidden md:flex space-x-4 items-center gap-5">
          ...
          <button className=" bg-gradient text-white rounded-full px-10 py-2">Login</button>
        </ul>
        <button
        ...
        >
          ...
          >
            <path d="M4 6H20M4 12H20M4 18H11Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
      </div>
      {isMobileMenuOpen && (
