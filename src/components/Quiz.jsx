  ...
  return (
    ...
    {/* navigation  */}
        ...
        <ul className='flex mt-20  font-semibold text-xl md:w-[40%] mx-auto justify-around'>
            <li className='pb-3 hover:cursor-pointer   hover:border-b-2  hover:border-blue-700 hover:text-blue-700'>Study</li>
            <li className='pb-3 hover:cursor-pointer   hover:border-b-2  hover:border-blue-700 hover:text-blue-700'>Quiz</li>
            <li className='pb-3 hover:cursor-pointer   hover:border-b-2  hover:border-blue-700 hover:text-blue-700'>Test</li>
            <li className='pb-3 hover:cursor-pointer   hover:border-b-2  hover:border-blue-700 hover:text-blue-700'>Game</li>
            <li className='pb-3 hover:cursor-pointer   hover:border-b-2  hover:border-blue-700 hover:text-blue-700'>Others</li>
        </ul>
