...
- **In the initial version of the project using the `create-vite@latest` a test react webpage is created**
...
```sh
  cd my-folder
  git clone https://github.com/navneet-Singh13/Assignment-Hyggex.git
```
...
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/navneet-singh-a61600228/)
